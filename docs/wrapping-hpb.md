...
MiniTables can be loaded into hpb through *MiniDescriptors*. MiniDescriptors are
...
One of the core design challenges when wrapping hpb is memory management.  Every
